...
#define GPIO_GATE_BANK        GPIOA
#define GPIO_GATE_SPI_CS      GPIO_SPI1_NSS
#define GPIO_GATE_SPI_SCK     GPIO_SPI1_SCK
#define GPIO_GATE_SPI_MOSI    GPIO_SPI1_MOSI
#define GPIO_GATE_SPI_MISO    GPIO_SPI1_MISO
