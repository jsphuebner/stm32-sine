...
#define GPIO_GATE_CS          GPIO8
#define GPIO_GATE_CS_BANK     GPIOB
#define GPIO_GATE_SPI_SCK     GPIO_SPI2_SCK
#define GPIO_GATE_SPI_MOSI    GPIO_SPI2_MOSI
#define GPIO_GATE_SPI_MISO    GPIO_SPI2_MISO
#define GPIO_GATE_SPI_BANK    GPIOB
#define GPIO_GATE_ENABLE      GPIO3
#define GPIO_GATE_ENABLE_BANK GPIO3
#define GATE_SPI              SPI2
#define RCC_GATE_SPI          RCC_SPI2

#define GPIO_PMIC_CS          GPIO13
#define GPIO_PMIC_CS_BANK     GPIOC
#define GPIO_PMIC_SPI_SCK     GPIO_SPI1_RE_SCK
#define GPIO_PMIC_SPI_MOSI    GPIO_SPI1_RE_MOSI
#define GPIO_PMIC_SPI_MISO    GPIO_SPI1_RE_MISO
#define GPIO_PMIC_SPI_BANK    GPIOB
#define PMIC_SPI              SPI1
#define RCC_PMIC_SPI          RCC_SPI1
